...
import { User as UserCredentials } from '@firebase/auth-types'
...
// workaround strictNullChecks and match imported UserInfo type
type FirebaseUser = UserCredentials | null
